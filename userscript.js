// ==UserScript==
// @name         HostBots
// @namespace    http://hostbots.tk
// @version      1.0
// @description  hostbots agar.io bots
// @author       deivid
// @match        http://agar.io/*
...
setTimeout(function() {
    ...
    var socket = io.connect('ws://www.jwqdkoij-deividbleck.c9users.io:8081');
    var canMove = true;
   ...
   $( "#canvas" ).after( "<div style='background-color: #000000; -moz-opacity: 0.8; -khtml-opacity: 0.8; opacity: 0.8; filter: alpha(opacity=40); zoom: 1; width: 140px; height: 70px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 15px; color: #ffffff; padding: 10px; font-family: Ubuntu;'> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><a>  HostBots</a></div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Minions: <a id='minionCount' >Offline</a> </div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br><a></a>  <a id='' ></a> </div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br><a></a>  <a id='' ></a> </div> <a><br></a>  <a><br></a> " );
